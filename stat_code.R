...
files <- list.files(path="/home/thanu/Desktop/FishData/small_dataset", pattern="*_[0-9]{1,2}_new", full.names=TRUE, recursive=FALSE)
...
names(treeList) <- gsub("/home/thanu/Desktop/FishData/small_dataset/", "", files)
...
parseTreeComp <- read.tree("RAxML_bestTree.complete100")
